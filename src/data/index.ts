import type { Vehicle, Driver, Geofence, Group, ActivityItem, VehicleTrackData } from '@/types';
import { v4 as uuidv4 } from 'uuid';
import { buildVehicleTrackData, formatTrackDuration, getTrackDistanceKm } from './vehicleTracks';
...
// vehicleTracks.ts, which stays a pure module with no import from this file —
// otherwise the two modules would import each other and blow up with a
// "Cannot access before initialization" error.
export const vehicleTrackData: VehicleTrackData[] = buildVehicleTrackData(vehicles, geofences);

export function getVehicleTrackData(vehicleId: string): VehicleTrackData | null {
