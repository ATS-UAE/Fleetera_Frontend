...
// Flattens a vehicle's stored trips/parking history (src/data/vehicleTracks.js) into
...
function buildRouteFromTrackData(vehicleId, fromTs, toTs) {
...
function findIndexForTs(route, ts) {
...
export default function TrackPlayerPage() {
  ...
  const pointMarkersRefs = useRef({});
  const playedLineRefs = useRef({});
  ...
  const timelineStackRef = useRef(null);
