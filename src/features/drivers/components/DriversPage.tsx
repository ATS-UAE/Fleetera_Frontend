...
function SortableDriverRow({ driver, selected, reorderMode, onSelect, onEdit, onDelete }) {
  ...
  const { isVisible } = useColumnVisibility('drivers');
  ...
  return (
    <div ref={setNodeRef} style={style} className={`${styles.driverRow} ${selected ? styles.selected : ''} ${reorderMode ? styles.reorderMode : ''}`} onClick={() => !reorderMode && onSelect(driver.id)}>
      ...
      <ColumnField
        list="drivers"
        fieldKey="avatar"
        fieldName="Driver Avatar"
        description="Driver initials avatar"
      ...
      <div className={styles.driverInfo}>
        ...
        <ColumnField
          list="drivers"
          fieldKey="driverCode"
          fieldName="Code / License Class"
          description="Driver code and license category"
          reorderMode={reorderMode}
        >
      ...
      <div className={styles.driverMeta}>
        ...
        <ColumnField
          list="drivers"
          fieldKey="statusBadge"
          fieldName="Status Badge"
          description="Current driver activity status"
          reorderMode={reorderMode}
