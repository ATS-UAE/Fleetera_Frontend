...
interface DetailRowProps { icon: React.ComponentType<{ size?: number }>; label: string; value: string; mono?: boolean; }
...
export default function GeofenceDetailPanel({ geofence, onClose, onEdit, onDelete, onToggleActive }: GeofenceDetailPanelProps) {
