...
export default function ReportsPage() {
  ...
  const handleDelete = (id) => {
    setGenerated(generated.filter(r => r.id !== id));
    notifications.show({ title: 'Report deleted', color: 'red' });
  };
                  ...
                  <Table.Td>
                    <div style={{ display: 'flex', gap: 4, justifyContent: 'flex-end' }}>
                      ...
                      <Tooltip label="Delete">
                        <ActionIcon size="sm" variant="subtle" color="red" onClick={() => handleDelete(r.id)}><IconTrash size={14} /></ActionIcon>
                      </Tooltip>
                    </div>
                  </Table.Td>
                </Table.Tr>
