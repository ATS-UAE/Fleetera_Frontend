...
export default function VehicleMap({ vehicles, selected, onSelect }: VehicleMapProps) {
  const mapRef = useRef<HTMLDivElement>(null);
  const mapInstanceRef = useRef<L.Map | null>(null);
  const markersRef = useRef<Record<string, L.Marker & { _fvMeta?: Record<string, unknown>; _fvPopupKey?: string }>>({});
