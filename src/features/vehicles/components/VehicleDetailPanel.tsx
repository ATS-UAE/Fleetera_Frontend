...
function DetailRow({ icon: Icon, label, value, mono = false }: { icon: React.ComponentType<{size?: number}>; label: string; value: string; mono?: boolean; }) {
  return (
...
export default function VehicleDetailPanel({ vehicle, onClose, onEdit, onDelete }: VehicleDetailPanelProps) {
